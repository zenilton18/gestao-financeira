...
<div class="container p-2 p-sm-3">
    ...
    {{-- 2. Seção de Gráficos e Distribuição --}}
    <div class="row g-3 mb-4">
        {{-- Gráfico de Faturamento por Origem/Serviço --}}
            ...
            <div class="card shadow-sm border-0 rounded-3 h-100">
                <div class="card-header bg-transparent border-0 pt-3 px-3 d-flex align-items-center justify-content-between">
                    <h6 class="fw-bold text-uppercase small text-muted mb-0">
                        <i class="bi bi-pie-chart me-1"></i> Faturamento por Origem
                    </h6>
                </div>
                <div class="card-body p-3">
                    <div class="row g-2 align-items-center">
                        ...
                        <div class="col-12 col-md-4">
                            <ul class="list-group list-group-flush small">
                                ...
                                <li class="list-group-item d-flex justify-content-between align-items-center px-0">
                                    <span>🧴 Produtos</span>
                                    <strong class="text-dark">R$ {{ number_format($faturamentoOrigem['venda_produtos'] ?? 0, 2, ',', '.') }}</strong>
                                </li>
                                <li class="list-group-item d-flex justify-content-between align-items-center px-0">
        ...
        <div class="col-12 col-lg-5">
            <div class="card shadow-sm border-0 rounded-3 h-100">
                <div class="card-header bg-transparent border-0 pt-3 px-3 d-flex align-items-center justify-content-between">
                    <h6 class="fw-bold text-uppercase small text-muted mb-0">
                        <i class="bi bi-calendar-event me-1"></i> Resumo de Hoje
                    </h6>
    ...
    <div class="card shadow-sm border-0 rounded-3">
        <div class="card-header bg-transparent border-0 pt-3 px-3 d-flex align-items-center justify-content-between">
            ...
            {{-- <a href="{{ route('contas.index') }}" class="btn btn-sm btn-link text-decoration-none">Ver Todos</a> --}}
        </div>
    ...
    document.addEventListener('DOMContentLoaded', function () {
        ...
        if (ctx) {
            new Chart(ctx, {
                type: 'doughnut',
                data: {
                    labels: ['Corte / Barba', 'Produtos', 'Combos / Planos', 'Outros'],
                    datasets: [{
                        data: [
                            {{ $faturamentoOrigem['corte_barba'] ?? 0 }},
                            {{ $faturamentoOrigem['venda_produtos'] ?? 0 }},
                ...
                options: {
                    ...
                    plugins: {
                        legend: {
                            display: false // Usamos a legenda customizada ao lado
                        }
                    }
                }
            });
