...
class ContaController extends Controller
{
    ...
    /**
     * Processa e salva o lançamento e suas parcelas.
     */
    public function store(Request $request)
{
    ...
    for ($i = 1; $i <= $totalParcelas; $i++) {
        ...
        Conta::create([
            ...
            'descricao'       => !empty($dadosValidados['descricao']) ? $dadosValidados['descricao'] : '',
            'valor'           => $valorParcela,
    ...
    return redirect()->route('contas.create')->with('sucesso', 'Lançamento cadastrado com sucesso!');
}
/**
 * Registra o pagamento/recebimento do lançamento.
 */
public function darBaixa(Request $request, $id)
{
    ...
    return redirect()->back()->with('sucesso', 'Lançamento marcado como pago com sucesso!');
}
}